...
const me ={
  ...
  achternaam: 'Vos',
  leeftijd: 28,
  geboortedatum: new Date(1993, 4, 28),
}
...
console.log('Hoi! Ik ben ' + me.voornaam + ', ik ben ' + me.leeftijd +' jaar oud.+');
...
const productomschrijving = 'De ' + product.productName + ' is gemaakt van ' + product.material[0] + ' en ' + product.material[1]
console.log(productomschrijving);
